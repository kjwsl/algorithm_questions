...
fn range_has_overlap<I>(range1: RangeInclusive<I>, range2: RangeInclusive<I>) -> bool
where
    I: std::cmp::PartialOrd,
{
    let end1 = range1.end();
    ...
    range2.contains(end1) || range1.contains(end2)
}
...
pub fn solve(input: &str) -> i32 {
    ...
    for pair in pairs {
        ...
        if range_has_overlap(range1, range2) {
            cnt += 1;
        }
    }
    cnt
